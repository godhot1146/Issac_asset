...
do
    if [[ "$indy_type" == "eir" ]]; then
        ...
        do
            ...
            xacro indy.urdf.xacro -o ${output_file} indy_type:=${indy_type} gripper_dh_ag95:=${gripper_dh_ag95} name:=indy
        ...
        do
            ...
            xacro indy.urdf.xacro -o ${output_file} indy_type:=${indy_type} indy_eye:=${indy_eye} name:=indy
        ...
        xacro indy.urdf.xacro -o ${output_file} indy_type:=${indy_type} indy_eye:=false name:=indy
